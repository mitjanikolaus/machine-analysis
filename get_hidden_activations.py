...
checkpoint_path = '../machine-zoo/baseline/lstm/4/'
test_data = '../machine-tasks/LookupTablesIgnoreEOS/lookup-3bit/samples/sample1/all.tsv'
...
run_and_get_hidden_activations(
    ...
    save_path="./baseline_lstm_4_all.pt"
)
